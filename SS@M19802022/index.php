...
echo setHeader("Implementing a web application that consumes the service of an OAuth Authorization Server and an OAuth Resource Server'");
...
if (isset($_REQUEST['logout'])) {
  ...
  header('Location: file-upload-index.php');
}
...
<?php if (isset($authUrl)): ?>
  ...
  <center><span class="warn"> <em>First connect to the drive to upload a photo on google drive. </em></span></center><br>
...
<?php elseif($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
  ...
  <div>
    ...
    <a href='file-upload-index.php'>Try with diffrent file</a>
  </div>
  <?php }else{ ?> </div> 
  <div>
    ...
    <a href='file-upload-index.php'>Upload more files</a>
  </div>
  <?php } ?>
<?php else: ?>
  <form method="POST" enctype="multipart/form-data">
    <input type="file" name="fileToUpload" required="required">
    <input type="submit" name="submit" value="Click here to uploadest files" />
  </form>
<?php endif ?>
